...
public class Quiz extends JFrame implements ActionListener {
    ...
    String pa[][] = new String[10][1]; // for storing responses from the students
    String qa[][] = new String[10][2];  // Array for correct answers
...
//        add(l1);
        ...
        question = new JLabel();
        question.setBounds(140, 300, 800, 30);
        ...
        // Storing Correct answers for checking
        ...
        lifeline = new JButton("Elimination");
    ...
    public void paint(Graphics g) { 
        ...
        //g.drawString(time, 960, 350);

        if (timer > 0) {
            g.drawString(time, 960, 350);
        } else {
            g.drawString("Times up !!", 960, 350);
        }
    ...
    public void start(int count) {
        ...
        // for selection options from the radio button
